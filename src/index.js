...
ReactDOM.render(
    <React.StrictMode>
      <HashRouter>
      <Routes>
      <Route path="/" exact={true} element={<><iframe src="models" className="featuresModels" frameBorder="0" title="3D Models" allowFullScreen></iframe><Suspense fallback={<div className="modelLoadingSpinner"></div>}></Suspense></>} />
